...
public class Prediction {
	...
	/**
	*This code is a part of project which is designed for providing better item recommendation
	*I think this code can show the foundation of my programming and the ability to do projects
	*I used Java to extract and purify features from Amazon dataset and prepared dataset for testing
	*I designed a MapReduce program in MongoDB to calculate similarity scores between users
	*I also designed a Collaborative Filtering algorithm based on similarity scores to improve recommendation precision.
	*
	*/
